...
async function signRs256(
  ...
  try {
    ...
    // The value is probably already

    // a normal private-key string.
  ...
  if (!match) {
    ...
    throw new Error(
      ...
      "It must contain the complete BEGIN PRIVATE KEY " +
  ...
  try {
    ...
    throw new Error(
      ...
      "FIREBASE_PRIVATE_KEY was decoded " +

      "but is not a valid PKCS8 private key."

...
async function importPrivateKey(
  ...
  if (!match) {
    ...
    throw new Error(
      ...
      "The Firebase private key is missing its BEGIN or END line."
  ...
  try {
    ...
    throw new Error(
      ...
      "The Firebase private key contains invalid characters."
